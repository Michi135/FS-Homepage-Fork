      ...
      <div style="max-width: 1100px; margin: 0 auto">
        ...
        <div>
          <ul>
            ...
            <li>Prodekane</li>
            <li>Studiendekan</li>
            <li>6 Vertreter der Hochschullehrer</li>
            <li>2 wissenschaftliche Mitarbeiter</li>
            <li>1 sonstiger Mitarbeiter</li>
            <li>der/die Frauenbeauftragte</li>
            <li class="important">
          ...
          <p>
            ...
            <span class="comment">(die Fachschaft)</span> jedes Jahr eine Liste
            ein, aus der dann die zwei Personen mit den meisten Stimmen in den
            Fakultätsrat gewählt werden.
          </p>
        </div>
        <p>
          Doch auch die, die sonst noch auf der Liste stehen, sind nicht umsonst
        ...
        <ul>
          ...
          <li>1 sonstigem Mitarbeiter</li>
          <li>3 Studierenden</li>
          <li>der/die Frauenbeauftragte</li>
          <li>den Dekanen der Fakultäten</li>
          <li>
        ...
        <div>
          <ul>
            ...
            <li>1 wissenschaftlichem Mitarbeiter</li>
            <li>2 Studierenden</li>
            <li>7 Persönlichkeiten <span class="comment">(*)</span></li>
          </ul>
          <p class="comment">
            (*) aus Wissenschaft, Kultur, Wirtschaft und beruflicher Praxis
        ...
        <p>
          Das StuPa ist eure fakultätsübergreifende studentische Vertretung an
        ...
        <p>
          ...
          kümmern
          <span class="comment">(und damit mit “hoheitlichem” Geld umgehen müssen)</span>
          oder die Fachschaft im StuPa vertreten wollen. Kurz gesagt: Wenn ihr
          nicht wisst, wen ihr wählen sollt:
        ...
        <p>
          ...
          mehrere Stimmen <span class="comment">(bis zu drei)</span> einer
