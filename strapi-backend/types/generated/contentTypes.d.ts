...
export interface ApiEinstellungenEinstellungen extends Schema.SingleType {
  collectionName: 'einstellungens';
  info: {
  ...
  attributes: {
    plakat: Attribute.Media & Attribute.Required;
    jahr: Attribute.Integer &
      Attribute.Required &
      Attribute.Unique &
      Attribute.SetMinMax<{
        min: 2000;
    ...
    keinePanik: Attribute.Media & Attribute.Required;
    Ferien: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiFeriensprechstundenFeriensprechstunden
  ...
  collectionName: 'feriensprechstundens';
  info: {
  ...
  attributes: {
    Feriensprechstunde: Attribute.Component<
...
export interface ApiNw2PartyNw2Party extends Schema.CollectionType {
  collectionName: 'nw_2_parties';
  info: {
    singularName: 'nw-2-party';
    pluralName: 'nw-2-parties';
    displayName: 'NW2 Party';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    Start: Attribute.DateTime &
      Attribute.Required &
      Attribute.Unique &
      Attribute.DefaultTo<'2023-03-25T23:00:00.000Z'>;
    Ende: Attribute.DateTime &
      Attribute.Required &
      Attribute.Unique &
      Attribute.DefaultTo<'2023-05-05T22:00:00.000Z'>;
    Preis: Attribute.Decimal & Attribute.Required & Attribute.DefaultTo<5>;
    Kuenstler: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Asskicker'>;
    Plakat: Attribute.Media & Attribute.Required;
    Plakat1x1: Attribute.Media;
    Plakat4x3: Attribute.Media;
    Plakat16x9: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::nw-2-party.nw-2-party',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSprechstundenSprechstunden extends Schema.SingleType {
  collectionName: 'sprechstundens';
  info: {
  ...
  attributes: {
    Montag: Attribute.Component<'sprechstunden.sprechstundentag'>;
    Dienstag: Attribute.Component<'sprechstunden.sprechstundentag'>;
    Mittwoch: Attribute.Component<'sprechstunden.sprechstundentag'>;
    Donnerstag: Attribute.Component<'sprechstunden.sprechstundentag'>;
    Freitag: Attribute.Component<'sprechstunden.sprechstundentag'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUniKinoFilmeUniKinoFilme extends Schema.CollectionType {
  ...
  attributes: {
    ...
    datum: Attribute.DateTime &
      ...
      Attribute.DefaultTo<'2022-04-01T18:00:00.000Z'>;
    ...
    jahr: Attribute.Integer &
      ...
      Attribute.DefaultTo<2010>;
    dauer: Attribute.Integer &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    genre: Attribute.Component<'uni-kino.genre', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiVertreterVertreter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    grad: Attribute.Enumeration<['Bachelor', 'Master']> &
      Attribute.Required &
      Attribute.DefaultTo<'Bachelor'>;
    feld: Attribute.Enumeration<['Science']> &
      Attribute.Required &
      Attribute.DefaultTo<'Science'>;
    ...
    hauptfach: Attribute.Component<'fachkombination.fach'> & Attribute.Required;
    lehramt: Attribute.Component<'fachkombination.lehramt'>;
    ...
    aktiv: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::nw-2-party.nw-2-party': ApiNw2PartyNw2Party;
